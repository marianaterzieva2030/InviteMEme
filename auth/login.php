...
try {
    $stmt = $pdo->prepare("SELECT id, email, password_hash, role FROM users 
    ...
    if ($user['role'] === 'teacher') {
        header('Location: /InviteMEme/home_teacher.html');
    } else {
        header('Location: /InviteMEme/home_student.html');
    }
    exit;
